...
public class GrammarTDBHelper<T extends GrammarsList> implements ChildEventListener {
    ...
    public GrammarTDBHelper(List<T> items, OnSimpleChildEventListener onSimpleChildEventListener) {
    ...
    public void hiedLearned(Boolean v){

    }

    public void hiedFavorite(Boolean v){
