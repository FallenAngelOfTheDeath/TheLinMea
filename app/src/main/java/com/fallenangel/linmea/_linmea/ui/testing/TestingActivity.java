package com.fallenangel.linmea._linmea.ui.testing;
...
import com.fallenangel.linmea._linmea.adapter.RecyclerViewTestingAnswers;
import com.fallenangel.linmea._linmea.data.firebase.FirebaseDictionaryWrapper;
import com.fallenangel.linmea._linmea.data.firebase.WordWrapper;
...
import com.fallenangel.linmea._linmea.model.Test;
...
import com.fallenangel.linmea._linmea.ui.testing.tests.QuestionGenerator;
...
import static com.fallenangel.linmea._linmea.model.TestConfig.CHOOSING_ANSWER;
import static com.fallenangel.linmea._linmea.model.TestConfig.CORRECT_WORD_LIM;
import static com.fallenangel.linmea._linmea.model.TestConfig.MANUAL_INPUT;
import static com.fallenangel.linmea._linmea.model.TestConfig.QUESTIONS_LIM;
import static com.fallenangel.linmea._linmea.model.TestConfig.WORD_REP_LIM;
import static com.fallenangel.linmea._modulus.auth.User.getCurrentUserUID;

public class TestingActivity extends Activity implements View.OnClickListener, OnRecyclerViewClickListener {
    ...
    private void loadDictionaries() {
        ...
        DatabaseReference databaseReference = mDatabaseReference.child(path);

        if (DEBUG == 1) Log.i(TAG, "loadTestingDictionary: " + path);
        ...
        databaseReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                for (String uid : testConfig.getPickedWordUids()) {
                    if (uid.equals(wordWrapper.getWord(dataSnapshot).getUid())) {
                        mTestingWords.add(wordWrapper.getWord(dataSnapshot));
                        // test.addWordToDictionary(wordWrapper.getWord(dataSnapshot));
                    }
                }

                if (count[0] >= testConfig.getDictSize()) {
                    if (DEBUG == 1) Log.i(TAG, "removeEventListener");
...
//    }
    ...
    private void finishTest(){
        ...
        Intent intent = new Intent(this, com.fallenangel.linmea._linmea.ui.testing.tests.TestResultActivity.class);
