...
public class DictionariesAdapter extends AbstractRecyclerViewAdapter<MyDictionaryModel, DictionariesAdapter.ViewHolder> {
    ...
    public DictionariesAdapter(Context context, List<MyDictionaryModel> items, OnRecyclerViewClickListener clickListener, OnStartDragListener dragStartListener, OnItemTouchHelper onItemTouchHelper) {
